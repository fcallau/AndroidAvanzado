...
internal object DBConstants {
    ...
    val KEY_SHOP_ENTITY_TYPE = "ENTITY_TYPE"
    ...
    val ALL_COLUMNS = arrayOf(KEY_SHOP_DATABASE_ID,
            KEY_SHOP_ID_JSON,
            KEY_SHOP_NAME, KEY_SHOP_ENTITY_TYPE, KEY_SHOP_IMAGE_URL,
            KEY_SHOP_LOGO_IMAGE_URL, KEY_SHOP_ADDRESS,
            KEY_SHOP_URL, KEY_SHOP_DESCRIPTION,
            KEY_SHOP_LATITUDE,
            KEY_SHOP_LONGITUDE,

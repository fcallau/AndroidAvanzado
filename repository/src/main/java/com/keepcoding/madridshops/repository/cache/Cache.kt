...
internal interface Cache {
    ...
    fun getAllShops(entityType: Int, success: (shops: List<ShopEntity>) -> Unit, error: (errorMessage: String) -> Unit)
    // fun saveAllShops(shops: List<ShopEntity>, success: () -> Unit, error: (errorMessage: String) -> Unit)
    fun saveAllShops(entityType: Int, shops: List<ShopEntity>, success: () -> Unit, error: (errorMessage: String) -> Unit)
